...
# Main class for the calculator UI
    ...
    # GUI
        ...
        self.input = Entry(self, bg = "#068789", bd = 12, 
        insertwidth = 5, width = 26,
        ...
        self.num_squared = Button(self, image = self.image_squared, highlightthickness = 0, bd = 0)
        self.num_squared.grid(row = 2, column = 3, sticky = W)
        
        # Squareroot Button
        self.image_square_root = PhotoImage(file = "Buttons/Square Root.png")
        self.num_square_root = Button(self, image = self.image_square_root, highlightthickness = 0, bd = 0)
        self.num_square_root.grid(row = 3, column = 3, sticky = W)
        
        # Delete Button
        self.image_delete= PhotoImage(file = "Buttons/Delete.png")
        self.num_delete = Button(self, image = self.image_delete, highlightthickness = 0, bd = 0)
        self.num_delete.grid(row = 4, column = 3, sticky = W)
        
        # Clear Button
        self.image_clear_all = PhotoImage(file = "Buttons/Clear All.png")
        self.num_clear_all = Button(self, image = self.image_clear_all, highlightthickness = 0, bd = 0)
